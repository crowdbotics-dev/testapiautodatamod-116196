...
## Project Structure
    ...
    ├── testapiautodatamod_116196  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_116196`
...
2. Clone this repo and `cd testapiautodatamod_116196`
